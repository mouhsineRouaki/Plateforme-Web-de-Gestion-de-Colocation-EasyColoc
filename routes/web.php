...
use App\Http\Controllers\Admin\AdminColocationController;
use App\Http\Controllers\Admin\AdminDashboardController;
use App\Http\Controllers\Admin\AdminUserController;
use App\Http\Controllers\CategoryController;
use App\Http\Controllers\ColocationHistoryController;
...
Route::get('/dashboard', [DashboardController::class, 'index'])->middleware(['auth', 'notBanned', 'verified'])->name('dashboard');
...
Route::middleware(['auth', 'notBanned', 'verified'])->group(function () {
    Route::get('/profile', [ProfileController::class, 'edit'])->name('profile.edit');
    Route::patch('/profile', [ProfileController::class, 'update'])->name('profile.update');
    Route::delete('/profile', [ProfileController::class, 'destroy'])->name('profile.destroy');
    Route::get('/colocations/history', [ColocationHistoryController::class, 'index'])->name('colocations.history');
...
Route::prefix('owner')->name('owner.')->middleware(['auth', 'notBanned', 'verified', 'owner'])->group(function () {
    ...
    Route::post('/colocations/{colocation}/cancel', [OwnerColocationController::class, 'cancel'])->name('colocations.cancel');
...
Route::prefix('member')->name('member.')->middleware(['auth', 'notBanned', 'verified', 'member'])->group(function () {
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'notBanned', 'verified', 'globalAdmin'])->group(function () {
    Route::get('/dashboard', [AdminDashboardController::class, 'index'])->name('dashboard');
    Route::get('/users', [AdminUserController::class, 'index'])->name('users.index');
    Route::get('/colocations', [AdminColocationController::class, 'index'])->name('colocations.index');
